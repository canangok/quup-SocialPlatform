...
<form class="form-horizontal form-landing" role="form" method="POST" action="">                        
    ...
    <input class="form-control passive valid" name="email" type="text" placeholder="E-Posta Adresi"  required="">                            
                           
    </div>                        
    
    <div class="form-group">                            
    <input class="form-control passive valid" placeholder="Şifre" name="sifre" type="password"  required="">                            
...
<form class="form-horizontal form-landing" role="form" method="POST" action="" >                        
  ...
  <div class="form-group">                            
       <input class="form-control" id="UserName" placeholder="Kullanıcı Adı" name="kullaniciAdi" type="text" value="" autocomplete="off" required="" >                            
       <
    </div>                        
