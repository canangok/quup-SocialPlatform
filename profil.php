	...
	<div class="rw-inner clearfix">
		<div class="rw-column rw-content rw-main-content">
          ...
          <?php if(isset($_GET['kullanici'])){ ?>
                   ...
                   <div class="center" style="margin-left: 67%;margin-top: -5%;">                    
                      ...
                      <div class="following-block clearfix text-center">    
			           ...
			           <div class="follow followers">                            
			            <div class="follow-in"><a href="profil_takip_ettikleri.php?kullanici=<?php echo $kullanici_getir['kullanici_id']; ?>"><span class="count"><?php echo $takipedilen-1;?></span><span class="title">takip edilen</span></a></div>
			           </div>   
			                        
			           <div class="follow following">                            
			            <div class="follow-in"><a href="#"><span class="count"><?php echo $takipci-1; ?></span><span class="title">takipçi</span></a></div>       
			           </div> 
	         ...
	         <ul>
	         <li class="active"><a href="profil.php?kullanici=<?php echo $kullanici_getir['kullanici_id']; ?>"><span class="title">Paylaşımlar</span></a></li>
	         ...
	         <li><a href="profil_fotograflar.php?kullanici=<?php  echo $kullanici_getir['kullanici_id']; ?>"><span class="title">Fotoğraflar</span></a></li> 
	         </ul>            
	         </div>        
	         </div>    
	         </div>    
...
<div class="new-post-container" id="div1" style="margin-top: -94%;">
		<?php if($_GET['kullanici'] == $_SESSION['kullanici_id']){ 
         include 'yeni_post.php'; 
         }?>
         <div>
